...
e.g.
    ...
    python run_model.py -d /data/wolf6245/data/ptb-xl/test_test -m model -o data/test_outputs -v
...
e.g.
    ...
    python evaluate_model.py -d /data/wolf6245/data/ptb-xl/test_test -o data/test_outputs -s data/evaluation/scores.csv
